  ...
  todos: [
    {
      ...
      'todo_start_time': moment('11-25-2018').hour('11').min('00').format('h:mma'),
      'complete': false
    },
    { 'todo_id': 2,
      'title': 'Todo 2',
      ...
      'percent': 40,
      'date': moment('11-25-2018').format('MM-DD-YYYY'),
      'todo_start_time': moment('11-25-2018').hour('11').min('15').format('h:mma'),
      'complete': false
    },
    { 'todo_id': 3,
      'title': 'Todo 3',
      ...
      'percent': 1.4,
      'date': moment('11-25-2018').format('MM-DD-YYYY'),
      'todo_start_time': moment('11-25-2018').hour('5').min('00').format('h:mma'),
      'complete': false
    },
    { 'todo_id': 4,
      'title': 'Todo 4',
      ...
      'percent': 40,
      'date': moment('11-25-2018').format('MM-DD-YYYY'),
      'todo_start_time': moment('11-25-2018').hour('6').min('00').format('h:mma'),
      'complete': false
    },
    // { 'todo_id': 5,
    //   'title': 'Todo 5',
